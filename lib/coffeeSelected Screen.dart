...
class CoffeeSelectedScreen extends StatefulWidget {



  // const ItemSelectedScreen({super.key, required this.data});

  const CoffeeSelectedScreen({Key? key, required this.name, required this.price, required this.image }) : super(key: key);
   final String name;
   final String price;
   final String image;

  @override
  State<CoffeeSelectedScreen> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<CoffeeSelectedScreen> {
